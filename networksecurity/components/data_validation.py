...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            train_file_path=self.data_ingestion_artifact.trained_data_path
            ...
            if not status_train:
                error_message_train="Train dataframe does not contain all columns"
            status_test=self.validate_number_of_columns(dataframe=test_dataframe)
            if not status_test:
                error_message_test="Test Dataframe does not contain all columns"
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                valid_train_file_path=self.data_ingestion_artifact.trained_data_path,
