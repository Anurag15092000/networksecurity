...
class DataIngest:
    ...
    def split_data_train_test_split(self,dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Exporting train and test filr path")
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataingestionartifact=DataIngestionArtifact(trained_data_path=self.data_ingestion_config.training_file_path,test_file_path=self.data_ingestion_config.testing_file_path)
